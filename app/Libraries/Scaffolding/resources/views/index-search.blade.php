                ...
                @if ($attributes['searchable'])
                    ...
                    <div class="col-xl-3 col-md-6 col-12 mb-1">
                        <div class="form-group">
                            ...
                            @php
                                $options = [];
                                if(is_iterable($attributes['searchOptions'])) $options = $attributes['searchOptions'];
                                else if($attributes['searchOptions'] instanceof \Closure) $options = call_user_func($attributes['searchOptions']);
