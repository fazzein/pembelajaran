...
<head>
    ...
    <title>Login Page - SDN HARAPAN</title>
                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                <a href="javascript:void(0);" class="brand-logo">
                                    <img src="{{ asset('template/src/logo.jpeg') }}" width="200px" alt="">
                                </a>

                                <h4 class="card-title" style="text-align: center; color:#2a2e30">Welcome to SDN Harapan ! 👋</h4>
                                <form class="auth-login-form" action="{{ route('login') }}" method="POST">
                                    @csrf
                                    <div class="form-group">
                                        <label style="color: #2a2e30" for="login-email" class="form-label">Email / NISN</label>
                                    ...
                                    <div class="form-group">
                                        <div class="d-flex justify-content-between">
                                            <label  style="color: #2a2e30" for="login-password">Password</label>
                                    ...
                                    <button type="submit" class="btn btn-success btn-block" tabindex="4">Sign
                                        in</button>
                                </form>
