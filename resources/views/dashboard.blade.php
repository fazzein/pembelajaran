        ...
        <div class="col-md-6 col-xl-4">
            <div class="card bg-success text-white">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div>
                        <h4 class="card-title text-white"><span class="siswa-count"></span> Siswa</h4>
        ...
        <div class="col-md-6 col-xl-4">
            <div class="card bg-warning text-white">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div>
                        <h4 class="card-title text-white"><span class="defect-count"></span> Guru Pembimbing</h4>
                        <p class="card-text">Jumlah Pembimbing</p>
                    </div>
                </div>
            </div>
        </div>
        <div class="col-md-6 col-xl-4">
            <div class="card bg-danger text-white">
                <div class="card-body d-flex align-items-center">
                    <i data-feather='users' class="mr-1" style="width: 70px; height: 70px;"></i>
                    <div>
                        <h4 class="card-title text-white"><span class="repair-count"></span> Perusahaan</h4>
                        <p class="card-text">Jumlah Perusahaan</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-baseline flex-sm-row flex-column">
                <h4 class="card-title">Grafik Pendaftaran Siswa Pkl</h4>
    ...
    function updateChart(bulan, tahun) {
        $.ajax({
            ...
            success: function(response) {
                ...
                var pendaftranData = response.pendaftranData;
                ...
                // Update card values
                $('.siswa-count').text(response.siswa);
                $('.defect-count').text(response.pembimbing);
                $('.repair-count').text(response.perusahaan);
                ...
                myChart = new Chart(ctx, {
                    ...
                    data: {
                        ...
                        datasets: [
                            {
                                label: 'Pendaftaran',
                                data: labels.map(day => pendaftranData[day] || 0),
