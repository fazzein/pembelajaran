    ...
    <div class="row">
        <div class="col-md-6 col-xl-3">
            <div class="card bg-primary text-white">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div>
                        <h4 class="card-title text-white">{{ $jumlahKader }} Kader</h4>
        ...
        <div class="col-md-6 col-xl-3">
            <div class="card bg-secondary text-white">
                <div class="card-body d-flex align-items-center">
                    <i data-feather='gift' class="mr-1" style="width: 70px; height: 70px;"></i>
                    <div>
                        <h4 class="card-title text-white"><span class="balita-count"></span> Balita</h4>
                        <p class="card-text">Yang terdaftar</p>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-6 col-xl-3">
            <div class="card bg-success text-white">
                <div class="card-body d-flex align-items-center">
                    ...
                    <div>
                        <h4 class="card-title text-white"><span class="ibuhamil-count"></span> Ibu Hamil</h4>
                        <p class="card-text">Yang terdaftar</p>
                    </div>
                </div>
            </div>
        ...
        <div class="col-md-6 col-xl-3">
            <div class="card bg-danger text-white">
                <div class="card-body d-flex align-items-center">
                    <i data-feather='smile' class="mr-1" style="width: 70px; height: 70px;"></i>
                    <div>
                        <h4 class="card-title text-white"><span class="lansia-count"></span> Lansia</h4>
                        <p class="card-text">Yang terdaftar</p>
                    </div>
                </div>
            </div>
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header d-flex justify-content-between align-items-baseline flex-sm-row flex-column">
                <h4 class="card-title">Grafik Posyandu</h4>
